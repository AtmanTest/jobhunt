...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "frontend: Frontend/display tests")
    config.addinivalue_line("markers", "cron: Scheduled job tests")
    config.addinivalue_line("markers", "navigation: Navigation tests")
    config.addinivalue_line("markers", "functional: Functional tests")
    config.addinivalue_line("markers", "critical: Critical severity")
